...
#define BLUEFRUIT_SPI_SCK              24
#define BLUEFRUIT_SPI_MISO             22
#define BLUEFRUIT_SPI_MOSI             23
...
void setup()
{
  ...
  if (! ble.sendCommandCheckOK(F("AT+GAPDEVNAME=UVMe UV Sensor Feather M0")) ) error(F("Could not set device name?"));
